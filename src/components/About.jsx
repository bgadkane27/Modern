...
const About = () => {
  return (
    <section id="about" className="relative overflow-hidden">
      ...
      {/* Hero Section */}
      <div className="relative z-10 text-center w-full min-h-screen max-w-7xl mx-auto flex flex-col justify-between items-center px-6 py-24 sm:px-8 md:px-16">
        <p className="text-xs tracking-widest uppercase">About Me</p>

        <div className="flex flex-col">
          <h1 className="text-4xl md:text-5xl font-bold tracking-wide mb-4">Mr. Baburao Adkane</h1>
          <p className="capitalize text-lg md:text-xl font-medium">" Quality isn't a task — it's a discipline "</p>
        </div>

        <p className="mt-6 text-sm tracking-wider capitalize">
