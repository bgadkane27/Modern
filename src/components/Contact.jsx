                    ...
                    return (
                        <div key={item.id} className="relative group">
                            ...
                            <img
                                src={item.image}
                                alt={`${item.label} icon`}
                                className="hidden md:block rounded-md absolute -top-16 left-1/2 -translate-x-1/2 opacity-0 group-hover:opacity-100 group-hover:-translate-y-24 transition-all duration-700 ease-in-out w-48 h-auto object-contain"
                            />
